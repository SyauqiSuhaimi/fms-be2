...
let subtaskService = class subtaskService {
    ...
    findsubtask(condition) {
        return this.subtaskRepository.find(condition);
    }
    async findOne(condition) {
        return this.subtaskRepository.findOne(condition);
    }
    create(data) {
    ...
    async saveData(processedData) {
        for (const item of processedData) {
            const area = this.subtaskRepository.create(item);
            await this.subtaskRepository.save(area);
        }
    }
};
