...
let workspaceController = class workspaceController {
    ...
    async fillAll() {
        const response = await this.WorkspaceService.findCompany({
    ...
    async findOne(id) {
        const response = await this.WorkspaceService.findOne({
            where: { id: id },
    ...
    async create(createworkspaceData) {
        const response = await this.WorkspaceService.create(createworkspaceData);
        return response;
    }
    async update(id, createworkspaceData) {
        console.log("test");
        console.log(createworkspaceData);
        const response = await this.WorkspaceService.findOne({ where: { id: id } });
        if (!response) {
            throw new common_1.BadRequestException("No Data");
        }
        else {
            const response2 = await this.WorkspaceService.update(id, createworkspaceData);
    ...
    async delete(id) {
        ...
        if (!response) {
            ...
            const response = await this.WorkspaceService.remove(id);
            return response;
        }
    }
};
...
], workspaceController.prototype, "fillAll", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], workspaceController.prototype, "fillAlldata", null);
__decorate([
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], workspaceController.prototype, "findbyUser", null);
__decorate([
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, workspace_entity_1.workspace]),
    __metadata("design:returntype", Promise)
