...
let DeductionService = class DeductionService {
    ...
    findCompany(condition) {
        return this.DeductionRepository.find(condition);
    }
    async findOne(condition) {
        return this.DeductionRepository.findOne(condition);
    }
    create(cases) {
        return this.DeductionRepository.save(cases);
    }
    async update(id, data) {
        return this.DeductionRepository.update(id, data);
    }
    async remove(id) {
