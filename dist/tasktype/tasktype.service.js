...
let tasktypeService = class tasktypeService {
    ...
    findtasktype(condition) {
        return this.tasktypeRepository.find(condition);
    }
    async findOne(condition) {
        return this.tasktypeRepository.findOne(condition);
    }
    create(data) {
        return this.tasktypeRepository.save(data);
    }
    async update(id, data) {
        return this.tasktypeRepository.update(id, data);
    }
    async remove(id) {
    ...
    async saveData(processedData) {
        for (const item of processedData) {
            const area = this.tasktypeRepository.create(item);
            await this.tasktypeRepository.save(area);
        }
    }
};
tasktypeService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(tasktype_entity_1.taskType)),
    __metadata("design:paramtypes", [typeorm_2.Repository])
], tasktypeService);
exports.tasktypeService = tasktypeService;
//# sourceMappingURL=tasktype.service.js.map