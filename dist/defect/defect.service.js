...
let defectService = class defectService {
    ...
    findCompany(condition) {
        return this.defectRepository.find(condition);
    }
    async findOne(condition) {
        return this.defectRepository.findOne(condition);
    }
    create(cases) {
        return this.defectRepository.save(cases);
    }
    async update(id, data) {
        return this.defectRepository.update(id, data);
    }
    async remove(id) {
...
defectService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(defect_entity_1.defect)),
